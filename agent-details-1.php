...
$sql = "SELECT * FROM users WHERE id = $agentId LIMIT 1";
$res = $conn->query($sql);
...
if (!empty($user['profile_image'])) {
  $image = "uploads/users/" . $user['profile_image'];
} else {
  $image = "images/default-agent.png";  // fallback
}
?>
...
<!-- Mirrored from templates.g5plus.net/homeid/agent-details-1.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:24:31 GMT -->
...
<head>
  ...
  <title>Agent Details 1 - HomeID</title>
  <!-- Google fonts -->
  ...
  <meta name="twitter:title" content="Agent Details 1">
  <meta name="twitter:description" content="Real Estate Html Template">
  <meta name="twitter:image" content="images/homeid-social-logo.php">
  <!-- Facebook -->
  <meta property="og:url" content="agent-details-1.php">
  <meta property="og:title" content="Agent Details 1">
      ...
      <div class="container">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb pt-6 pt-lg-0 pb-0">
            <li class="breadcrumb-item"><a href="home-01.php">Home</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="pl-md-10 pr-md-8 py-7">
              ...
              <p class="fs-16 font-weight-500 lh-213 mb-4">
                <?php echo $title1; ?>
              </p>

              <p class="mb-1">
                Company Agent at <a href="#" class="text-heading">Modern House Real Estate</a>
              </p>
              ...
              <div class="row">
                <div class="col-sm-6 mb-4">
                  ...
                  <p class="text-heading font-weight-500 mb-0 lh-13"><?php echo $mobile; ?></p>
                  <p class="text-heading font-weight-500 mb-0 lh-13"><?php echo $phone; ?></p>
                </div>

                <div class="col-sm-6 mb-4">
                  <p class="mb-0">Email</p>
                  <p class="text-heading font-weight-500 mb-0 lh-13"><?php echo $email; ?></p>
                </div>

                <div class="col-sm-6 mb-4">
                  <p class="mb-0">Website</p>
                  <p class="text-heading font-weight-500 mb-0 lh-13"><?php echo $website; ?></p>
                </div>
              </div>
                ...
                <div class="col-sm-6">
                  <ul class="list-inline text-gray-lighter m-0 p-0">
                    <li class="list-inline-item mx-0 my-1">
                      <a href="<?php echo $twitter; ?>" class="..."><i class="fab fa-twitter"></i></a>
                    </li>
                    <li class="list-inline-item mr-0 ml-2 my-1">
                      <a href="<?php echo $facebook; ?>" class="..."><i class="fab fa-facebook-f"></i></a>
                    </li>
                    <li class="list-inline-item mr-0 ml-2 my-1">
                      <a href="<?php echo $instagram; ?>" class="..."><i class="fab fa-instagram"></i></a>
                    </li>
                    <li class="list-inline-item mr-0 ml-2 my-1">
                      <a href="<?php echo $linkedin; ?>" class="..."><i class="fab fa-linkedin-in"></i></a>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <div class="container">
        <div class="row">
          ...
          function getBadgeClass($category)
          {
            ...
            if (in_array($cat, ['for rent', 'rent', 'for lease', 'lease'], true)) {
              return 'badge-indigo';
            }
            // default = sale
          ...
          // get all properties (adjust WHERE if you need agent-specific)
          $sql    = "SELECT * FROM properties WHERE user_id = $agentId ORDER BY id DESC";
          ...
          if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
              ...
              $size    = isset($row['size']) && $row['size'] !== '' ? (string)$row['size'] : '-';
              ...
              // bathrooms & garages
              $bath = (isset($row['bathroom']) && trim((string)$row['bathroom']) !== '' && trim((string)$row['bathroom']) !== '0')
                ? (string)$row['bathroom']
                : '-';

              $garage = (isset($row['garages']) && trim((string)$row['garages']) !== '' && trim((string)$row['garages']) !== '0')
                ? (string)$row['garages']
                : '-';

              // year
              $yearRaw = isset($row['yearbuilt']) ? trim((string)$row['yearbuilt']) : '';
              $year    = ($yearRaw === '' || $yearRaw === '0') ? '-' : $yearRaw;

              // price (normalized display)
              $priceVal = $row['price'] ?? '';
              $norm     = str_replace([',', '₹', ' '], ['', '', ''], $priceVal);
              $price    = is_numeric($norm)
                ? '₹' . number_format((float)$norm)
                : ($priceVal !== '' ? $priceVal : '-');
              ...
              $tabKey   = null;
              if (in_array($catLower, ['for sale', 'sale'], true)) {
                $tabKey = 'sale';
              } elseif (in_array($catLower, ['for rent', 'rent'], true)) {
                $tabKey = 'rent';
              } elseif (in_array($catLower, ['for lease', 'lease'], true)) {
                $tabKey = 'lease';
              }

              // property array used by the HTML
              $prop = [
                'id'       => $pid,
                'title'    => $title,
                'address'  => $address,
              ...
              // push into specific tab array if we detected a type
              if ($tabKey !== null) {
                $properties[$tabKey][] = $prop;
              }
            }
          }
          ?>
            ...
            <div class="collapse-tabs mb-10">
              <ul class="nav nav-tabs text-uppercase d-none d-md-inline-flex agent-details-tabs" role="tablist">
                <li class="nav-item">
                  <a href="#all" class="nav-link active shadow-none fs-13"
                    ...
                    All (<?php echo count($properties['all']); ?>)
                  </a>
                </li>
                <li class="nav-item ml-0">
                  <a href="#sale" class="nav-link shadow-none fs-13"
                    data-toggle="tab" role="tab">
                    For Sale (<?php echo count($properties['sale']); ?>)
                  </a>
                </li>
                <li class="nav-item ml-0">
                  <a href="#rent" class="nav-link shadow-none fs-13"
                    data-toggle="tab" role="tab">
                    For Rent (<?php echo count($properties['rent']); ?>)
                  </a>
                </li>
                <li class="nav-item ml-0">
                  <a href="#lease" class="nav-link shadow-none fs-13"
                    data-toggle="tab" role="tab">
                    For Lease (<?php echo count($properties['lease']); ?>)
                  </a>
                </li>
              </ul>
              ...
              <div class="tab-content shadow-none pt-7 pb-0 px-6 bg-white">
                <div id="collapse-tabs-accordion-01">
                    ...
                    <div class="card border-0 bg-transparent">
                      ...
                      <div id="all-collapse-01" class="collapse show collapsible"
                        ...
                        <div class="card-body p-0">
                          <div class="row">
                            <?php if (!empty($properties['all'])): ?>
                              <?php foreach ($properties['all'] as $p): ?>
                                <?php
                                $pid      = (int)($p['id'] ?? 0);
                                $imgSrc   = !empty($p['imgSrc'])
                                  ? htmlspecialchars($p['imgSrc'], ENT_QUOTES, 'UTF-8')
                                  : 'images/properties-grid-35.jpg';
                                $imgCount = (int)($p['imgCount'] ?? 0);
                                $vidCount = (int)($p['vidCount'] ?? 0);
                                ...
                                <div class="col-md-6 mb-7">
                                  <div class="card border-0">
                                    <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                      <img src="<?php echo $imgRaw; ?>" style="height: 300px; object-fit: cover; width:100%;" class="rounded-lg"
                                        alt="<?php echo htmlspecialchars($p['title'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                                      <div class="card-img-overlay d-flex flex-column">
                                        <div class="mb-auto">
                                          <span class="badge <?php echo getBadgeClass($p['category'] ?? ''); ?>">
                                        ...
                                        <div class="d-flex hover-image">
                                          <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                                            <li class="list-inline-item mr-2"
                                              data-toggle="tooltip"
                                              title="<?php echo $imgCount; ?> Images">
                                              <a href="single-property-1.php?id=<?php echo $pid; ?>"
                                                class="text-white hover-primary">
                                                <i class="far fa-images"></i>
                                                <span class="pl-1"><?php echo $imgCount; ?></span>
                                              </a>
                                            </li>
                                            <li class="list-inline-item"
                                              data-toggle="tooltip"
                                              title="<?php echo $vidCount; ?> Videos">
                                              <a href="single-property-1.php?id=<?php echo $pid; ?>"
                                                class="text-white hover-primary">
                                                <i class="far fa-play-circle"></i>
                                                <span class="pl-1"><?php echo $vidCount; ?></span>
                                              </a>
                                            </li>
                                          </ul>
                                    ...
                                    <div class="card-body pt-3 px-0 pb-1">
                                      ...
                                      <p class="font-weight-500 text-gray-light mb-0">
                                        <?php echo htmlspecialchars($p['address'] ?? '', ENT_QUOTES, 'UTF-8'); ?>
                                        <?php if (!empty($p['city'])) echo ', ' . htmlspecialchars($p['city'], ENT_QUOTES, 'UTF-8'); ?>
                                      </p>
                                      <p class="fs-17 font-weight-bold text-heading mb-0 lh-16">
                                        <?php echo htmlspecialchars($p['price'] ?? '', ENT_QUOTES, 'UTF-8'); ?>
                                      </p>
                                    </div>
                  ...
                  <div class="tab-pane tab-pane-parent fade" id="sale" role="tabpanel">
                    <div class="card border-0 bg-transparent">
                      ...
                      <div id="sale-collapse-01" class="collapse collapsible"
                        ...
                        <div class="card-body p-0">
                          <div class="row">
                            <?php if (!empty($properties['sale'])): ?>
                              <?php foreach ($properties['sale'] as $p): ?>
                                <?php
                                $pid      = (int)($p['id'] ?? 0);
                                $imgSrc   = !empty($p['imgSrc'])
                                  ? htmlspecialchars($p['imgSrc'], ENT_QUOTES, 'UTF-8')
                            ...
                            <?php else: ?>
                              <div class="col-12">
                                <p class="mb-0">No properties for sale.</p>
                              </div>
                            <?php endif; ?>
                          </div>
                        </div>
                  ...
                  <div class="tab-pane tab-pane-parent fade" id="rent" role="tabpanel">
                    <div class="card border-0 bg-transparent">
                      ...
                      <div id="rent-collapse-01" class="collapse collapsible"
                        ...
                        <div class="card-body p-0">
                          <div class="row">
                            <?php if (!empty($properties['rent'])): ?>
                              <?php foreach ($properties['rent'] as $p): ?>
                                <?php
                                $pid      = (int)($p['id'] ?? 0);
                                $imgSrc   = !empty($p['imgSrc'])
                                  ? htmlspecialchars($p['imgSrc'], ENT_QUOTES, 'UTF-8')
                                  : 'images/properties-grid-36.jpg';
                                $imgCount = (int)($p['imgCount'] ?? 0);
                                $vidCount = (int)($p['vidCount'] ?? 0);
                            ...
                            <?php else: ?>
                              <div class="col-12">
                                <p class="mb-0">No properties for rent.</p>
                              </div>
                            <?php endif; ?>
                          </div>
                        </div>
                  ...
                  <!-- ================= LEASE TAB ================= -->
                  <div class="tab-pane tab-pane-parent fade" id="lease" role="tabpanel">
                    <div class="card border-0 bg-transparent">
                      <div class="card-header border-0 d-block d-md-none bg-transparent p-0"
                        id="headingLease-01">
                        <h5 class="mb-0">
                          <button class="btn lh-2 fs-18 bg-white py-1 px-6 shadow-none w-100 collapse-parent border collapsed mb-4"
                            data-toggle="collapse"
                            data-target="#lease-collapse-01"
                            aria-expanded="true"
                            aria-controls="lease-collapse-01">
                            For Lease (<?php echo count($properties['lease']); ?>)
                          </button>
                        </h5>
                      </div>
                      <div id="lease-collapse-01" class="collapse collapsible"
                        aria-labelledby="headingLease-01"
                        data-parent="#collapse-tabs-accordion-01">
                        <div class="card-body p-0">
                          <div class="row">
                            <?php if (!empty($properties['lease'])): ?>
                              <?php foreach ($properties['lease'] as $p): ?>
                                <?php
                                $pid      = (int)($p['id'] ?? 0);
                                $imgSrc   = !empty($p['imgSrc'])
                                  ? htmlspecialchars($p['imgSrc'], ENT_QUOTES, 'UTF-8')
                            ...
                            <?php else: ?>
                              <div class="col-12">
                                <p class="mb-0">No properties for lease.</p>
                              </div>
                            <?php endif; ?>
                          </div>
                        </div>
                ...
                </div><!-- /#collapse-tabs-accordion-01 -->
              </div><!-- /.tab-content -->
            </div><!-- /.collapse-tabs -->
          </div><!-- /.col-lg-8 -->
            ...
            <div class="primary-sidebar-inner">
                ...
                <div class="card-body px-6 py-6">
                  <div class="media mb-4">
                    <img src="<?php echo $image; ?>"
                      class="rounded-circle mr-2" alt="Blanche Gordon" style="width: 70px; ">
                    <div class="media-body">
                      <p class="fs-16 lh-1 text-dark mb-0 font-weight-500">
                        <?php echo $name; ?> </p>
                      <p class="mb-0"> <?php echo $title1; ?> </p>
              ...
              <div class="card">
                <div class="card-body text-center pt-7 pb-6 px-0">
                  ...
                  <a href="home-01.php?openLogin=1" class="btn btn-primary">Register</a>
                </div>
              </div>
            </div>
          </div>
...
<!-- Mirrored from templates.g5plus.net/homeid/agent-details-1.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:24:37 GMT -->
