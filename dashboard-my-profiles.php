...
// Map DB columns to variables (adjust these keys if your columns have different names)
...
// profile image: if stored, show upload path, else use fallback
// Many implementations store just filename; adapt if you store full path or URL.
$profile_image_db = $user['profile_image'] ?? '';

if (!empty($profile_image_db)) {
  // If stored value already is a URL or starts with '/', keep it; otherwise assume uploads/users/filename
  if (filter_var($profile_image_db, FILTER_VALIDATE_URL) || strpos($profile_image_db, '/') === 0) {
    $profileSrc = $profile_image_db;
  } else {
    $profileSrc = 'uploads/users/' . ltrim($profile_image_db, '/');
  }
} else {
  // fallback to the image you uploaded previously (developer asked that path be used)
  // note: developer environment will transform local path to a URL if needed
  $profileSrc = '/mnt/data/Screenshot (27).png'; // <-- fallback local path you provided earlier
}
?>
...
<!-- Mirrored from templates.g5plus.net/homeid/dashboard-my-profiles.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:23:06 GMT -->
...
<head>
  ...
  <!-- Facebook -->
  <meta property="og:url" content="dashboard-my-profiles.php">
      ...
      <div class="page-content">
        ...
        <main id="content" class="bg-gray-01">
          <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
            ...
            <form method="POST" action="update_profile.php" enctype="multipart/form-data">
              <div class="row mb-6">
                <div class="col-lg-6">
                    ...
                    <div class="card-body px-6 pt-6 pb-5">
                      <div class="row">
                        ...
                        <div class="col-sm-8 col-xl-12 col-xxl-5">
                          <!-- preview uses profileSrc from PHP -->
                          <img id="profilePreview" src="<?php echo h($profileSrc); ?>" alt="Profile" class="w-100" style="object-fit:cover; max-height:400px;">

                          <div class="custom-file mt-4 h-auto">
                            <!-- note: input name matches update_profile.php -->
                            <input type="file" class="custom-file-input" hidden id="customFile" name="profile_image" accept="image/*">
                  ...
                  <div class="card mb-6">
                    <div class="card-body px-6 pt-6 pb-5">
                      ...
                      <p class="card-text">Enter your details</p>

                      <div class="form-row mx-n4">
                        <div class="form-group col-md-6 px-4">
                          <label for="firstName" class="text-heading">First name</label>
                          <input type="text" class="form-control form-control-lg border-0" id="firstName" name="firstName" value="<?php echo h($firstName); ?>">
                        </div>

                        <div class="form-group col-md-6 px-4">
                          <label for="lastName" class="text-heading">Last name</label>
                          <input type="text" class="form-control form-control-lg border-0" id="lastName" name="lastName" value="<?php echo h($lastName); ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-row mx-n4">
                        <div class="form-group col-md-6 px-4">
                          ...
                          <input type="text" class="form-control form-control-lg border-0" id="phone" name="phone" value="<?php echo h($phone); ?>">
                        </div>

                        <div class="form-group col-md-6 px-4">
                          <label for="mobile" class="text-heading">Mobile</label>
                          <input type="text" class="form-control form-control-lg border-0" id="mobile" name="mobile" value="<?php echo h($mobile); ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-row mx-n4">
                        <div class="form-group col-md-6 px-4 mb-md-0">
                          ...
                          <input type="email" class="form-control form-control-lg border-0" id="email" name="email" value="<?php echo h($email); ?>">
                        </div>
                      </div>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="card mb-6">
                    <div class="card-body px-6 pt-6 pb-5">
                      <h3 class="card-title mb-0 text-heading fs-22 lh-15">Social Links</h3>

                      <div class="form-group">
                        <label for="facebook" class="text-heading">Facebook Url</label>
                        <input type="url" class="form-control form-control-lg border-0" id="facebook" name="facebook" value="<?php echo h($facebook); ?>">
                      </div>

                      <div class="form-group">
                        <label for="instagram" class="text-heading">Instagram Url</label>
                        <input type="url" class="form-control form-control-lg border-0" id="instagram" name="instagram" value="<?php echo h($instagram); ?>">
                      </div>

                      <div class="form-group">
                        <label for="twitter" class="text-heading">Twitter Url</label>
                        <input type="url" class="form-control form-control-lg border-0" id="twitter" name="twitter" value="<?php echo h($twitter); ?>">
                      </div>

                      <div class="form-group">
                        <label for="linkedin" class="text-heading">Linkedin Url</label>
                        <input type="url" class="form-control form-control-lg border-0" id="linkedin" name="linkedin" value="<?php echo h($linkedin); ?>">
                      </div>

                      <div class="form-group mb-7">
                        <label for="website" class="text-heading">Website Url</label>
                        <input type="url" class="form-control form-control-lg border-0" id="website" name="website" value="<?php echo h($website); ?>">
                      </div>
                  ...
                  <div class="card mb-6 mb-lg-0">
                    <div class="card-body px-6 pt-6 pb-5">
                      ...
                      <p class="card-text">Your professional details</p>

                      <div class="form-group mb-0">
                        <label for="title" class="text-heading">Title / Position</label>
                        <input type="text" class="form-control form-control-lg border-0" id="title" name="title" value="<?php echo h($title); ?>">
                      </div>
              ...
              <div class="d-flex justify-content-end flex-wrap">
                <button type="button" class="btn btn-lg bg-hover-white border rounded-lg mb-3">Delete Profile</button>
            ...
            // get logged in user id (change key if your session uses something else)
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['change_password'])) {
              ...
              // 1) basic checks
              if ($userId <= 0) {
                $cp_error_msg = 'Please log in again.';
              } elseif ($old === '' || $new === '' || $confirm === '') {
                $cp_error_msg = 'All password fields are required.';
              } elseif ($new !== $confirm) {
                $cp_error_msg = 'New password and confirm password do not match.';
              } elseif (strlen($new) < 6) {
                $cp_error_msg = 'New password must be at least 6 characters long.';
              } else {

                // 2) fetch current password hash from DB
                $res = $conn->query("SELECT password FROM users WHERE id = {$userId} LIMIT 1");

                if (!$res || $res->num_rows !== 1) {
                  $cp_error_msg = 'User not found.';
                } else {
                  $row         = $res->fetch_assoc();
                  ...
                  if (!password_verify($old, $currentHash)) {
                    $cp_error_msg = 'Old password is incorrect.';
                  } else {

                    // 4) hash new password and update
                    $newHash = password_hash($new, PASSWORD_DEFAULT);
                    $safe    = $conn->real_escape_string($newHash);

                    if ($conn->query("UPDATE users SET password = '{$safe}' WHERE id = {$userId}")) {
                      $cp_success_msg = 'Password changed successfully.';
                    } else {
                      $cp_error_msg = 'Database error while updating password.';
                    }
                  }
                }
              }
            ...
            <?php if ($cp_error_msg): ?>
              <div class="alert alert-danger">
                <?= htmlspecialchars($cp_error_msg) ?>
              </div>
            <?php endif; ?>

            <?php if ($cp_success_msg): ?>
              <div class="alert alert-success">
                <?= htmlspecialchars($cp_success_msg) ?>
              </div>
            <?php endif; ?>
              ...
              <div class="card">
                <div class="card-body px-6 pt-6 pb-5">
                  ...
                  <div class="form-row mx-n4">
                    ...
                    <div class="form-group col-md-6 px-4">
                      <label for="confirmNewPassword" class="text-heading">Confirm Password</label>
                      <input type="password" class="form-control form-control-lg border-0"
...
<!-- Mirrored from templates.g5plus.net/homeid/dashboard-my-profiles.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:23:07 GMT -->
