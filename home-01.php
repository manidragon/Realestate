...
<!-- Mirrored from templates.g5plus.net/homeid/home-01.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:16:09 GMT -->
            ...
            <div class="container container-xxl">
                <div class="d-flex align-items-center">
                    ...
                    <nav class="navbar navbar-expand-xl bg-transparent px-0 w-100 w-xl-auto">
                        ...
                        <!-- LOGO SECTION -->
                        <a class="navbar-brand mr-7" href="home-01.php">
                            <img src="images/Final-t-realtors-.png" alt="HomeID" class="normal-logo "
                                style="width: 100px;">
                            <img src="images/Final-t-realtors-.png" alt="HomeID" class="sticky-logo"
                                style="width: 100px;">
                        </a>
                        ...
                        <!-- TOGGLER BUTTON (MOBILE MENU ICON) -->
                        ...
                        <div class="collapse navbar-collapse mt-3 mt-xl-0 mx-auto flex-grow-0" id="primaryMenu02">
                            <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n4 ">

                                <!-- HOME DROPDOWN -->
                                <!-- <li id="navbar-item-home" class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4">
                                    <a class="nav-link dropdown-toggle p-0" href="home-01.php" data-toggle="dropdown">
                                    ...
                                    <ul class="dropdown-menu pt-3 pb-0 pb-xl-3" aria-labelledby="navbar-item-home">
                                        <li class="dropdown-item active"><a class="dropdown-link"
                                                href="home-01.php">Home 01</a></li>
                                    </ul>
                                </li> -->
                                <!-- /HOME DROPDOWN END -->

                                <!-- LISTING DROPDOWN -->
                                <li id="navbar-item-listing" class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4">
                                    <a class="nav-link p-0" href="listing-full-width-list.php">
                                        Listing
                                    </a>


                                </li>
                                <!-- /LISTING DROPDOWN END -->

                                <!-- DASHBOARD DROPDOWN -->
                                <li id="navbar-item-dashboard" class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4">
                                    <a class="nav-link  p-0" href="dashboard.php">
                                        Dashboard
                                    </a>
                                    <!-- <ul class="dropdown-menu pt-3 pb-0 pb-xl-3" aria-labelledby="navbar-item-dashboard">
                                        ...
                                        <li class="dropdown-item"><a class="dropdown-link"
                                                href="dashboard-add-new-property.php">Add New
                                                Property</a></li>
                                        <li class="dropdown-item"><a class="dropdown-link"
                                                href="dashboard-my-properties.php">My
                                                Properties</a></li>
                                        <li class="dropdown-item"><a class="dropdown-link"
                                                href="dashboard-my-favorites.php">My
                                                Favorites</a></li>
                                        <li class="dropdown-item"><a class="dropdown-link"
                                                href="dashboard-my-packages.php">My Package</a>
                                        </li>
                                        <li class="dropdown-item"><a class="dropdown-link"
                                                href="dashboard-my-profiles.php">My Profile</a>
                                        </li>
                                        <li class="dropdown-item"><a class="dropdown-link"
                                                href="signup-and-login.php">Signup and login</a>
                                        </li>
                                        <li class="dropdown-item"><a class="dropdown-link"
                                                href="password-recovery.php">Password
                                                Recovery</a></li>
                                    </ul> -->
                                </li>
                                ...
                                <li id="navbar-item-dashboard" class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4">
                                    <a class="nav-link  p-0" href="contact-us-1.php">
                                        Contact us
                                    </a>
                                </li>
                                ...
                                <!-- <li id="navbar-item-pages" class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4">
                                    ...
                                    <ul class="dropdown-menu pt-3 pb-0 pb-xl-3" aria-labelledby="navbar-item-pages">
                                        ...
                                        <li class="dropdown-item">
                                            <a class="dropdown-link" href="about-us.php">About us</a>
                                        </li>

                                        <li class="dropdown-item ">
                                            <a id="navbar-link-contact-us" href="contact-us-1.php">
                                                Contact us
                                            </a>
                                        ...
                                        <li class="dropdown-item dropdown dropright">
                                            ...
                                            <ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3"
                                                ...
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="agents-grid-1.php">Agents grid 1</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="agents-grid-2.php">Agents grid 2</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="agents-grid-with-sidebar.php">Agents
                                                        grid with sidebar</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="agents-list.php">Agents list</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="agent-details-1.php">Agent detais
                                                        1</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="agent-details-2.php">Agent detais
                                                        2</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="dropdown-item">
                                            <a id="navbar-link-checkout" class="dropdown-link"
                                                href="checkout-complete-1.php">
                                                Checkout
                                            </a>
                                        </li>
                                        <li class="dropdown-item">
                                            <a id="navbar-link-payment-completed" class="dropdown-link"
                                                href="checkout-complete-2.php">
                                                Payment Completed
                                            </a>
                                        </li>

                                        <li class="dropdown-item">
                                            <a id="navbar-link-packages" class="dropdown-link" href="packages.php">
                                                Packages
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li id="navbar-item-docs" aria-haspopup="true" aria-expanded="false"
                                    ...
                                    <div class="dropdown-menu px-0 pt-3 dropdown-menu-docs">
                                        <div class="dropdown-body">
                                            <a class="dropdown-item py-1" href="about-us.php">
                                                <div class="media">
                                                    <div class="fs-20 mr-3">
                                                        <i class="fal fa-file-alt"></i>
                                                    </div>
                                                    <div class="media-body">
                                                        <span class="d-block lh-15">About us</span>
                                                    </div>
                                ...
                                <ul
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link pl-3 pr-2" data-toggle="modal"
                                            href="#login-register-modal">Become a seller</a>
                                    </li>
                                    <li class="nav-item ml-auto w-100 w-sm-auto">
                                        <a class="btn btn-primary btn-lg" href="dashboard-add-new-property.php">
                                            Add listing
                    ...
                    <div class="ml-auto d-none d-xl-block">
                        <ul
                            ...
                            <li class="divider"></li>
                            <li class="nav-item ">
                                <a class="nav-link pl-3 pr-2" data-toggle="modal" href="#login-register-modal">Become a seller</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="btn btn-outline-light btn-lg text-white rounded-lg bg-hover-primary border-hover-primary hover-white d-none d-lg-block"
                                    href="dashboard-add-new-property.php">
                                    Add listing
    ...
    <main id="content">
        <section class="d-flex flex-column">
            <div style="background-image: url('images/bg-home-01.jpg')" class="bg-cover d-flex align-items-center custom-vh-100">
                <div class="container pt-lg-15 py-8" data-animate="zoomIn">
                    <p class="text-white fs-md-22 fs-18 font-weight-500 letter-spacing-367 mb-6 text-center text-uppercase">Let us guide your home</p>
                    <h2 class="text-white display-2 text-center mb-sm-13 mb-8">Find Your Dream Home</h2>

                    <!-- Desktop form -->
                    <form action="listing-full-width-grid-2.php" method="get" class="property-search py-lg-0 z-index-2 position-relative d-none d-lg-block">
                        <div class="row no-gutters">
                            <div class="col">
                                <!-- hidden status field (will be updated by JS) -->
                                <input class="search-field" type="hidden" id="statusInput" name="status" value="For Sale" data-default-value="For Sale">

                                <ul class="nav nav-pills property-search-status-tab" id="statusTabs" role="tablist">
                        ...
                        <div class="bg-white px-6 rounded-bottom rounded-top-right pb-6 pb-lg-0">
                            <div class="row align-items-center" id="accordion-4">
                                <div class="col-md-6 col-lg-5 col-xl-5 pt-6 pt-lg-0 order-1">
                                    ...
                                    <select class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input"
                                        ...
                                        <option value="Comercial land">Comercial land</option>
                                        <option value="Agriculture land">Agriculture land</option>
                                    </select>
                                </div>

                                <div class="col-md-6 col-lg-4 col-xl-5 pt-6 pt-lg-0 order-2">
                                    <label class="text-uppercase font-weight-500 letter-spacing-093">Cities</label>
                                ...
                                <div class="col-sm pt-5 pb-5 pt-lg-5 order-sm-4 order-5">
                    ...
                    <!-- Mobile form -->
                    <form action="listing-full-width-grid-2.php" method="get"
                        ...
                        <div class="row align-items-lg-center" id="accordion-4-mobile">
                            <div class="col-12">
                                <div class="form-group mb-0 position-relative">
                                    <a href="#advanced-search-filters-4-mobile"
                                        ...
                                        aria-expanded="true" aria-controls="advanced-search-filters-4-mobile"></a>

                                    <input type="text" class="form-control form-control-lg border shadow-none pr-9 pl-11 bg-white placeholder-muted"
                            ...
                            <div id="advanced-search-filters-4-mobile" class="col-12 pt-2 px-7 collapse" data-parent="#accordion-4-mobile">
                                <div class="row mx-n2">
                                    <!-- STATUS on mobile MUST have name="status" -->
                                    <div class="col-sm-6 pt-4 px-2">
                                        <select class="form-control border shadow-none form-control-lg selectpicker bg-transparent"
                                            title="Select" data-style="btn-lg py-2 h-52 bg-transparent" name="status">
        ...
        <script>
            (function() {
                ...
                // initialize active state from hidden input (useful if page loaded with ?status=...)
                setActiveByValue(statusInput.value || statusInput.getAttribute('data-default-value'));
                ...
                tabs.forEach(function(tab) {
                    tab.addEventListener('click', function(ev) {
                        ...
                        if (!val) return;
                        // update hidden input and active classes
        ...
        <?php
        $sql_sale = "SELECT * FROM properties WHERE category = 'For Sale' ORDER BY id DESC";
            ...
            <div class="container container-xxl">
                <div class="row">
                    ...
                    <div class="col-md-6 text-md-right">
                        <a href="listing-full-width-grid-2.php?status=For+Sale&type=&city="
                ...
                <?php if ($result && $result->num_rows > 0): ?>
                    <div class="slick-slider slick-dots-mt-0 custom-arrow-spacing-30"
                        ...
                        <?php while ($row = $result->fetch_assoc()):
                            ...
                            $sizeRaw = $row['size'] ?? '';
                            $size    = $sizeRaw !== '' ? h($sizeRaw) : '';
                            $priceRaw = $row['price'] ?? '';
                            $price   = is_numeric($priceRaw) ? number_format($priceRaw) : h($priceRaw);

                            // ---------- Bedrooms detection ----------
                            $possible_bed_cols = ['bedroom', 'bedrooms', 'beds', 'bed', 'br', 'bedroom_count', 'rooms'];
                            $bedrooms_val = null;
                            foreach ($possible_bed_cols as $c) {
                            ...
                            $bedrooms = $bedrooms_val !== null ? h($bedrooms_val) : '-';

                            // ---------- Get first image from property_images (if exists) ----------
                            $image_path = null;
                            if ($pid > 0) {
                                $stmt = $conn->prepare("SELECT file_path FROM property_images WHERE property_id = ? ORDER BY id ASC LIMIT 1");
                                if ($stmt) {
                                    $stmt->bind_param('i', $pid);
                                    $stmt->execute();
                                    $stmt->bind_result($fp);
                                    if ($stmt->fetch() && !empty($fp)) {
                                        $image_path = $fp;
                                    }
                                    $stmt->close();
                                }
                            ...
                            // ---------- Resolve path taking into account uploads/properties/{pid}/images/ ----------
                            $web_image = resolve_web_image_for_property($image_path, $pid);
                        ?>
                            <div class="box box pb-7 pt-2" data-animate="fadeInUp">
                                <div class="card shadow-hover-2">
                                    <div class="hover-change-image bg-hover-overlay card-img-top overflow-hidden">
                                        <!-- Use the resolved web_image exactly like your Rent block -->
                                        <img src="<?php echo h($image_path); ?>" alt="<?php echo $title; ?>" class="img-fluid" style="height: 250px; width: 100%; object-fit: cover;">
                                    ...
                                    <div class="card-body pt-3">
                                        <h2 class="card-title fs-16 lh-2 mb-0">
                                            <a href="single-property-1.php?id=<?php echo $pid; ?>" class="text-dark hover-primary">
                                                <?php echo $title; ?>
                                            </a>
                                        </h2>
                                        <p class="card-text font-weight-500 text-gray-light mb-2"><?php echo $address; ?></p>

                                        <ul class="list-inline d-flex mb-0 flex-wrap mr-n5">
                                            <?php if ($bedrooms !== '-' && intval(trim((string)$bedrooms)) > 0): ?>
                                                <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5"
                                                    data-toggle="tooltip" title="<?php echo htmlspecialchars($bedrooms) . ' Bedroom'; ?>">
                                                    <svg class="icon icon-bedroom fs-18 text-primary mr-1">
                                                        <use xlink:href="#icon-bedroom"></use>
                                                    </svg>
                                                    <?php echo htmlspecialchars($bedrooms) . ' Br'; ?>
                                                </li>
                                            <?php endif; ?>
                ...
                <?php else: ?>
                    <div class="text-center mt-5">
                        <p class="text-muted">No properties found for Sale.</p>
                    </div>
                <?php endif; ?>
        ...
        /**
         * Resolve a raw DB-stored path (filename, relative path, or URL) to a web-usable path.
         * Tries several likely folders including the property-specific uploads folder.
         * $pid is the property id (used to check uploads/properties/{pid}/images/)
         */
        function resolve_web_image_for_property($rawPath, $pid = 0)
        {
            $placeholder = 'images/placeholder.jpg';
            if (empty($rawPath) && $pid <= 0) return $placeholder;
            ...
            // remove leading slashes for candidate building
            $p = ltrim($p, '/');

            // Build candidates. order matters.
            $candidates = [];

            // 1) If property-specific directory is known, try that first:
            if ($pid > 0) {
                $candidates[] = "uploads/properties/{$pid}/images/{$p}";  // filename in folder
                $candidates[] = "uploads/properties/{$pid}/images/{$p}";  // redundant-safe
                // also try if rawPath already contains a subfolder relative to that dir
                if ($p) $candidates[] = "uploads/properties/{$pid}/images/{$p}";
            }

            // 2) Common variants and raw
            if ($p !== '') {
                $candidates[] = $p;                        // as stored
                $candidates[] = 'images/' . $p;
                $candidates[] = 'uploads/' . $p;
                $candidates[] = 'uploads/properties/' . $p;
                $candidates[] = 'property_images/' . $p;
                $candidates[] = '/' . $p;
            }

            // 3) If no rawPath given, still try property folder for any image named "cover.jpg" or "main.jpg"
            if ($p === '' && $pid > 0) {
                $candidates[] = "uploads/properties/{$pid}/images/cover.jpg";
                $candidates[] = "uploads/properties/{$pid}/images/main.jpg";
            }

            // try each candidate and return the first that exists (or absolute URL)
            foreach ($candidates as $cand) {
                if (!$cand) continue;
                if (filter_var($cand, FILTER_VALIDATE_URL)) return $cand;

                // server path check
                $serverPath = rtrim($_SERVER['DOCUMENT_ROOT'], '/') . '/' . ltrim($cand, '/');
                if (file_exists($serverPath) && is_file($serverPath)) {
                    return $cand; // web relative path
                }
            }
        ...
        $sql = "SELECT * FROM properties WHERE category = 'For Rent' ORDER BY id DESC";
        $result = $conn->query($sql);
        ?>

        <section class="pt-lg-5 pb-lg-8 py-11">
            <div class="container container-xxl">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6 text-md-right">
                        <a href="listing-full-width-grid-2.php?status=For+Rent&type=&city="
                    ...
                    <div class="slick-slider slick-dots-mt-0 custom-arrow-spacing-30"
                        ...
                        ?>
                            <div class="box box pb-7 pt-2" data-animate="fadeInUp">
                                <div class="card shadow-hover-2">
                                    <div class="hover-change-image bg-hover-overlay  card-img-top overflow-hidden">
                                        <img src="<?php echo ($image_path); ?>" alt="<?php echo $title; ?>" class="img-fluid " style="height: 250px; width: 100%; object-fit: cover; ">
                                        <div class="card-img-overlay p-2 d-flex flex-column">
                                            <div>
                                    ...
                                    <div class="card-body pt-3">
                                        ...
                                        <ul class="list-inline d-flex mb-0 flex-wrap mr-n5">
                                            <?php if (isset($bedrooms) && intval(trim((string)$bedrooms)) > 0): ?>
                                                <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5"
                                                    data-toggle="tooltip" title="<?php echo htmlspecialchars($bedrooms) . ' Bedroom'; ?>">
                                                    <svg class="icon icon-bedroom fs-18 text-primary mr-1">
                                                        <use xlink:href="#icon-bedroom"></use>
                ...
                <?php else: ?>
                    <div class="text-center mt-5">
                        <p class="text-muted">No properties found for rent.</p>
                    </div>
                <?php endif; ?>
        ...
        <?php
        $sql_lease = "SELECT * FROM properties WHERE category = 'For Lease' ORDER BY id DESC";
        $result = $conn->query($sql_lease);
        ?>
        <section class="pt-lg-12 pb-lg-10 py-11">
            <div class="container container-xxl">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="text-heading">Best Properties For Lease</h2>
                        <span class="heading-divider"></span>
                        <!-- <p class="mb-6">Lorem ipsum dolor sit amet, consec tetur cing elit. Suspe ndisse suscipit</p> -->
                    </div>
                    <div class="col-md-6 text-md-right">
                        <a href="listing-full-width-grid-2.php?status=For+Lease&type=&city="
                            class="btn fs-14 text-secondary btn-accent py-3 lh-15 px-7 mb-6 mb-lg-0">See all properties
                            <i class="far fa-long-arrow-right ml-1"></i>
                        </a>
                    </div>
                            ...
                            <div class="box box pb-7 pt-2" data-animate="fadeInUp">
                                <div class="card shadow-hover-2">
                                    <div class="hover-change-image bg-hover-overlay card-img-top overflow-hidden">
                                        ...
                                        <div class="card-img-overlay p-2 d-flex flex-column">
                                            <div>
                                                <span class="badge mr-2 badge-indigo">for Lease</span>
                                            </div>
                                        </div>
                                    </div>
                ...
                <?php else: ?>
                    <div class="text-center mt-5">
                        <p class="text-muted">No properties found for Lease.</p>
                    </div>
                <?php endif; ?>
        ...
        <section class="pt-lg-5 pb-lg-15 py-11">
            <div class="container container-xxl">
                <h2 class="text-heading">Find By Locations</h2>
                <span class="heading-divider"></span>
                <h4 class="mb-7">உங்களுக்கு விரும்பமான இடங்களை தேர்வு செய்ய</h4>
                ...
                <div class="slick-slider mx-n2"
                    ...
                    <div class="box px-2" data-animate="fadeInUp">
                        <a href="listing-full-width-grid-1.php?city=Theni" aria-label="View listings in Theni" class="d-block">
                            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                                <img src="images/properties-city-01.jpeg" class="card-img" alt="Theni" style="height:350px; object-fit:cover;">
                                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                                    <h2 class="card-title mb-0 fs-20 lh-182">Theni</h2>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <!-- Bodi -->
                    <div class="box px-2" data-animate="fadeInUp">
                        <a href="listing-full-width-grid-1.php?city=Bodi" aria-label="View listings in Bodi" class="d-block">
                            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                                <img src="images/properties-city-02.jpeg" class="card-img" alt="Bodi" style="height:350px; object-fit:cover;">
                                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                                    <h2 class="card-title mb-0 fs-20 lh-182">Bodi</h2>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <!-- Andipatti -->
                    <div class="box px-2" data-animate="fadeInUp">
                        <a href="listing-full-width-grid-1.php?city=Andipatti" aria-label="View listings in Andipatti" class="d-block">
                            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                                <img src="images/properties-city-03.jpeg" class="card-img" alt="Andipatti" style="height:350px; object-fit:cover;">
                                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                                    <h2 class="card-title mb-0 fs-20 lh-182">Andipatti</h2>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <!-- Uthamapalayam -->
                    <div class="box px-2" data-animate="fadeInUp">
                        <a href="listing-full-width-grid-1.php?city=Uthamapalayam" aria-label="View listings in Uthamapalayam" class="d-block">
                            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                                <img src="images/properties-city-04.jpeg" class="card-img" alt="Uthamapalayam" style="height:350px; object-fit:cover;">
                                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                                    <h2 class="card-title mb-0 fs-20 lh-182">Uthamapalayam</h2>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <!-- Periyakulam -->
                    <div class="box px-2" data-animate="fadeInUp">
                        <a href="listing-full-width-grid-1.php?city=Periyakulam" aria-label="View listings in Periyakulam" class="d-block">
                            <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                                <img src="images/properties-city-05.jpeg" class="card-img" alt="Periyakulam" style="height:350px; object-fit:cover;">
                                <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                                    <h2 class="card-title mb-0 fs-20 lh-182">Periyakulam</h2>
                                </div>
                            </div>
                        </a>
                    </div>
        ...
        <section class="bg-accent pt-10 pb-lg-11 pb-8 bg-patten-04">
            <div class="container container-xxl">
                <h2 class="text-dark text-center mxw-800 fs-26 lh-184 px-md-8">
                    தேனி மாவட்டத்தில் உள்ள சிறந்த சொத்துக்களை </h2>
                <h2 class="text-dark text-center mxw-751 fs-26 lh-184 px-md-8">
                    உங்களுக்கு அறிமுக படுத்துவதில் பெருமை கொள்கிறோம்</h2>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-sm-9">
                                    <div class="card-body p-0 pl-0 pl-sm-5 pt-5 pt-sm-0">
                                        ...
                                        <p class="mb-0"> Explore verified properties, modern apartments, and premium villas
            in top locations. Find your perfect home with flexible pricing and
            secure documentation.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-sm-9">
                                    <div class="card-body p-0 pl-0 pl-sm-5 pt-5 pt-sm-0">
                                        ...
                                        <p class="mb-0">List your property with expert support, accurate valuation, and maximum
    market exposure to sell faster at the best possible price.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-sm-9">
                                    <div class="card-body p-0 pl-0 pl-sm-5 pt-5 pt-sm-0">
                                        ...
                                        <p class="mb-0">Find comfortable rental homes, apartments, and villas in prime locations
    with flexible terms and verified property listings.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="bg-single-image-02 bg-accent py-lg-10 py-10">
            <div class="container">
                <div class="row">
                    <div class="col-ld-6 col-sm-7" data-animate="fadeInLeft">
                        <div class="pl-6 border-4x border-left border-primary">
                            <h2 class="text-heading lh-15 fs-md-32 fs-25">எங்கள் நிறுவனத்தின் <span
                                    class="text-primary"> ரியல் எஸ்டேட் நிர்வாகி</span> ஆக விருப்பமா?</h2>
                            <p class="lh-2 fs-md-15 mb-0">ரியல் எஸ்டேட் துறையில் ஆர்வம் இருப்பவர்கள் விண்ணப்பிக்கவும்.
                            </p>
                        </div>
                    </div>
                    <div class="col-ld-6 col-sm-5 text-center mt-sm-0 mt-8" data-animate="fadeInRight">
                        <a href="#login-register-modal" class="btn btn-lg btn-primary mt-2 px-10" data-toggle="modal">விருப்பம்</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container container-xxl">
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-6 mb-md-0">
                    ...
                    <div class="lh-26 font-weight-500">
                        <p class="mb-0">119, First Floor, Arun Aakash Complex, Bodinayakanur</p>
                        <a class="d-block text-muted hover-white"
                            href="mailto:contact@homeid.com">info@thenirealtors.com</a>
                        <a class="d-block text-lighter font-weight-bold fs-15 hover-white"
                            href="tel:(+68)122109876">(+91)86677
                            01998</a>
            ...
            <div class="mt-0 mt-md-10 row">
                ...
                <p class="col-md-auto mb-0 text-muted">
                    © 2025 Theni Realtors. All rights reserved by Nearlook Marketings.
                </p>
            </div>
        </div>
    </footer>
                ...
                <div class="modal-body p-4 py-sm-7 px-sm-8">
                    <div class="tab-content shadow-none p-0" id="myTabContent">
                        <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                            ...
                            <form class="form" method="post" action="login_process.php" id="loginForm">
                                <div id="response" style="display:none; color:red;" class="mt-3 text-center"></div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="text" class="form-control border-0 shadow-none fs-13" id="username"
                                            name="username02" required placeholder="Username">
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="password" class="form-control border-0 shadow-none fs-13"
                                            id="password" name="password02" required placeholder="Password">
                                        <div class="input-group-append">
                                ...
                                <button type="submit" name="login" class="btn btn-primary btn-lg btn-block">Log
                                    in</button>
                            </form>
                                        ...
                                        try {
                                            ...
                                            if (data.status === 'success1') {
                                                Swal.fire({
                                                    ...
                                                    willClose: () => {
                                                        window.location.href = 'dashboard-add-new-property.php';
                                                    }
                                                });
                                            ...
                                            Swal.fire({
                                                icon: 'error',
                                                title: 'Server error',
                                                text: 'Could not contact server: ' + err.message
                                            });
                                            if (responseDiv) {
                                                responseDiv.style.display = 'block';
                                                responseDiv.style.color = 'red';
                                                responseDiv.textContent = 'Server error: ' + err.message;
                                            }
                                        } finally {
                        ...
                        <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                            ...
                            <form class="form" id="registerForm" method="post" action="">
                                ...
                                <div id="response01" style="display:none; font-weight:600;" class="mt-3 text-center">
                                </div>

                                <!-- FULL NAME -->
                                <div class="form-group mb-4">
                                    <label for="full-name" class="sr-only">Mobile Number</label>
                                    <div class="input-group input-group-lg">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text bg-gray-01 border-0 text-muted fs-18">
                                        ...
                                        <input type="tel" class="form-control border-0 shadow-none fs-13"
                                            id="full-name" name="mobile01" required placeholder="Mobile Number" maxlength="10">
                                    </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="text" class="form-control border-0 shadow-none fs-13"
                                            id="username01" name="username01" required placeholder="Username">
                                    </div>
                            ...
                            <script>
                                ...
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    const username = document.getElementById("username01");
                                    const password = document.getElementById("password01");

                                    const fullNameError = document.getElementById("fullNameError");
                                    const usernameError = document.getElementById("usernameError");
                                    const passwordError = document.getElementById("passwordError");
                                    const response = document.getElementById("response01");
...
if (!mobileRegex.test(fullName.value.trim())) {
    showError(
        fullNameError,
    ...
    valid = false;
                                        ...
                                        if (!userRegex.test(username.value.trim())) {
                                            showError(usernameError,
                                                "Username must be 4–15 chars (letters, numbers, underscores)."
                                            );
                                            valid = false;
                                        }
                                        ...
                                        if (!passRegex.test(password.value.trim())) {
                                            showError(passwordError,
                                                "Password must be at least 8 chars with 1 letter & 1 number."
                                            );
                                            valid = false;
                                        }
                                        ...
                                        try {
                                            ...
                                            response.style.color = (data.status === "success") ?
                                                "green" : "red";
                                            ...
                                            response.textContent = "Server error: " + err.message;
                                        }
                                    });
                                });
                            </script>
                            ...
                            <script>
                                document.querySelectorAll('.input-group').forEach(group => {
                                    const eyeIcon = group.querySelector('.fa-eye-slash, .fa-eye');
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (urlParams.get("openLogin") === "1") {
            ...
            // remove param so refresh doesn't re-open modal
...
<!-- Mirrored from templates.g5plus.net/homeid/home-01.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:17:13 GMT -->
