          ...
          <div class="mt-6 form-search-01">
            <form class="form-inline mx-n1" id="accordion-5" action="listing-full-width-grid-2.php" method="get">
              <div class="form-group p-1">
                ...
                <select class="form-control border-0 shadow-xxs-1 bg-transparent font-weight-600 selectpicker" id="city"
                  name="city" title="Location" data-style="bg-white">
                  <option value="" <?php echo ($city==='' ) ? 'selected' : '' ; ?>>All Cities</option>
                  <option value="Theni Taluk" <?php echo ($city==='Theni Taluk' ) ? 'selected' : '' ; ?>>Theni Taluk
                  </option>
                  <option value="Bodi Taluk" <?php echo ($city==='Bodi Taluk' ) ? 'selected' : '' ; ?>>Bodi Taluk
                  </option>
                  <option value="Andipatti Taluk" <?php echo ($city==='Andipatti Taluk' ) ? 'selected' : '' ; ?>
                    >Andipatti Taluk</option>
                  <option value="Uthamapalayam Taluk" <?php echo ($city==='Uthamapalayam Taluk' ) ? 'selected' : '' ; ?>
                    >Uthamapalayam Taluk</option>
                  <option value="Periyakulam Taluk" <?php echo ($city==='Periyakulam Taluk' ) ? 'selected' : '' ; ?>
                    >Periyakulam Taluk</option>
                </select>
              </div>

              <div class="form-group p-1">
                <label for="type" class="sr-only">Type</label>
                <select class="form-control border-0 shadow-xxs-1 bg-transparent font-weight-600 selectpicker" id="type"
                  name="type" title="Type" data-style="bg-white">
                  ...
                  <option value="Commercial land" <?php echo ($type==='Commercial land' ) ? 'selected' : '' ; ?>
                    >Commercial land</option>
                  <option value="Agriculture land" <?php echo ($type==='Agriculture land' ) ? 'selected' : '' ; ?>
              ...
              <div class="form-group p-1">
                ...
                <select class="form-control border-0 shadow-xxs-1 bg-transparent font-weight-600 selectpicker"
                  ...
                  <option value="For Lease" <?php echo ($statusRaw)==='For Lease' ? 'selected' : '' ; ?>>For Lease
                  </option>
                </select>
              </div>

              <div class="form-group p-1">
                <input type="text" name="key-word" class="form-control" placeholder="Keyword"
        ...
        <div class="row align-items-sm-center">
          <div class="col-md-6">
            <h2 class="fs-15 text-dark mb-0">
              We found <span class="text-primary">
                <?php echo h($totalMatching); ?>
              </span> properties available for you
            </h2>
          </div>
            ...
            <div class="d-flex justify-content-md-end align-items-center">
              <form id="sortForm" method="get" action="<?php echo h($_SERVER['PHP_SELF']); ?>">
                ...
                <div class="input-group border rounded input-group-lg w-auto bg-white mr-3">
                  <label class="input-group-text bg-transparent border-0 text-uppercase pr-1 pl-3" for="sortSelect"><i
                      class="fas fa-align-left fs-16 pr-2"></i>Sortby:</label>
                  <select id="sortSelect" name="sortby" onchange="this.form.submit()"
                    class="form-control border-0 bg-transparent selectpicker">
          ...
          <div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
            <div class="card border-0 hover-change-image">
              <div class="bg-hover-overlay rounded-lg card-img overflow-hidden">
                <img src="<?php echo h($imgRaw); ?>" alt="<?php echo $title; ?>" class="img-fluid"
                  style="height: 250px; width: 100%; object-fit: cover;">
                <div class="card-img-overlay p-2 d-flex flex-column">
                  <div><span class="badge badge-primary">
                      <?php echo h($row['category'] ?? 'For Sale'); ?>
                    </span></div>
                  <div class="mt-auto d-flex hover-image">
                    <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                      ...
                      <li class="list-inline-item" data-toggle="tooltip" title="<?php echo $vidCount; ?> Videos">
                        <a href="single-property-1.php?id=<?php echo $pid; ?>" class="text-white hover-primary">
                          <i class="far fa-play-circle"></i><span class="pl-1">
                            <?php echo $vidCount; ?>
                          </span>
                        </a>
                      </li>
                    ...
                    <ul class="list-inline mb-0 d-flex align-items-end mr-n3">
                      ...
                      <li class="list-inline-item h-32 mr-3" data-toggle="tooltip" title="Compare">
                        <a href="#" class="text-white fs-20 hover-primary"><i class="fas fa-exchange-alt"></i></a>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="card-body pt-3 px-0 pb-1">
                <h2 class="fs-16 mb-1"><a href="single-property-1.php?id=<?php echo $pid; ?>"
                    class="text-dark hover-primary">
                    <?php echo $title; ?>
                  </a></h2>
                <p class="font-weight-500 text-gray-light mb-1">
                  <?php echo $address; ?>
                </p>
        ...
        <nav class="pt-6">
          <ul class="pagination rounded-active justify-content-center mb-0">
            ...
            <li class="page-item <?php echo ($page <= 1) ? 'disabled' : ''; ?>">
              <a class="page-link" href="<?php echo ($page > 1) ? ('?' . build_query(['page' => $page - 1])) : '#'; ?>">
            ...
            <li class="page-item <?php echo ($p == $page) ? 'active' : ''; ?>">
              <a class="page-link" href="<?php echo '?' . build_query(['page' => $p]); ?>">
                <?php echo $p; ?>
              </a>
            </li>
            <?php endfor;
