...
<!-- Mirrored from templates.g5plus.net/homeid/about-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:23:30 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <main id="content">
      ...
      <section style="background-image: url('images/bg-about-us.jpg')"
        ...
        <div class="container position-relative z-index-2 text-center">
          <a href="https://www.youtube.com/watch?v=0O2aH4XLbto" class="d-inline-block m-auto position-relative play-animation" data-gtf-mfp="true" data-mfp-options='{"type":"iframe"}'>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-6 col-lg-3 mb-6 mb-lg-0">
              <a href="agents-grid-with-sidebar.php"
            ...
            <div class="col-sm-6 col-lg-3 mb-6 mb-lg-0">
              <a href="blog-grid-with-sidebar.php"
                   class="card border-0 shadow-2 px-7 py-5 h-100 shadow-hover-lg-1">
                <div class="card-img-top d-flex align-items-end justify-content-center">
...
<!-- Mirrored from templates.g5plus.net/homeid/about-us.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:23:49 GMT -->
</html>