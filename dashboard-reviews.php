...
<!-- Mirrored from templates.g5plus.net/homeid/dashboard-reviews.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:23:05 GMT -->
...
<head>
  ...
  <!-- Facebook -->
  <meta property="og:url" content="dashboard-reviews.php">
  ...
  <div class="wrapper dashboard-wrapper">
    <div class="d-flex flex-wrap flex-xl-nowrap">
      ...
      <div class="page-content">
        ...
        // If admin logged in → show all inquiries
        // If normal user logged in → show only inquiries for that user

        if ($userType === 'admin') {

          $sql = "
      SELECT pi.*, p.title AS property_title, u.fullname AS user_fullname
      FROM property_inquiries AS pi
      LEFT JOIN properties AS p ON pi.property_id = p.id
      LEFT JOIN users AS u ON pi.user_id = u.id
      ORDER BY pi.id DESC
    ";
        } else {
        ...
        <main id="content" class="bg-gray-01">
          <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
            ...
            <div class="mb-6">
              ...
              <p class="mb-1">List of all inquiries submitted by users.</p>
            </div>
                ...
                <?php while ($row = $res->fetch_assoc()): ?>
                  <div class="media border-top pt-7 pb-6 d-sm-flex d-block text-sm-left text-center">
                    ...
                    <div class="media-body">
                      ...
                      <!-- Message -->
                      <p class="mb-3 pr-xl-17">
                        <?= nl2br(htmlspecialchars($row['message'])) ?>
                      </p>

                      <!-- Email + Phone -->
                      <p class="mb-1">Email: <?= htmlspecialchars($row['email']) ?></p>
                      <p class="mb-3">Phone: <?= htmlspecialchars($row['phone']) ?></p>
