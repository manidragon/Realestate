...
<!-- Mirrored from templates.g5plus.net/homeid/contact-us-1.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:23:58 GMT -->
...
<head>
  ...
  <!-- Facebook -->
  <meta property="og:url" content="contact-us-1.php">
...
<body>
  ...
  <main id="content">
    ...
    <section class="py-2 py-lg-4 page-title bg-overlay-opacity-01"
      ...
      <div class="container">
        <div class="card border-0 mt-n13 z-index-3 pb-8 pt-10">
          <div class="card-body p-0">
            <h2 class="text-heading mb-2 fs-22 fs-md-32 text-center lh-16">Get In Touch</h2>
            <p class="text-center mxw-670 mb-8">
              Customer Satisfication is our First Priority. Please feel free to contact us for any doubts.
            </p>
            ...
            <div class="card border-0">
              <div class="media align-items-end">
                ...
                <div class="media-body">
                  <h4 class="fs-22 lh-15 mb-0 text-heading">Reach Us</h4>
                </div>
              </div>
              <div class="card-body px-0 pt-3 pb-0">
                <p class="card-text mb-0">
                  Shop 119, Arun Aakash Complex First Floor, Bodinayakanur
                </p>
          ...
          <div class="col-md-4 mb-6">
            <div class="card border-0">
              <div class="media align-items-end">
                ...
                <div class="media-body">
                  <h4 class="fs-22 lh-15 mb-0 text-heading">Drop A Mail</h4>
                </div>
              </div>
              <div class="card-body px-0 pt-3 pb-0">
                <p class="card-text mb-0">
                  info@thenirealtors.com
                </p>
          ...
          <div class="col-md-4 mb-6">
            <div class="card border-0">
              <div class="media align-items-end">
                ...
                <div class="media-body">
                  <h4 class="fs-22 lh-15 mb-0 text-heading">Call Us</h4>
                </div>
              </div>
              <div class="card-body px-0 pt-3 pb-0">
                <p class="card-text mb-0">
