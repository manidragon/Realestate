...
<!-- Mirrored from templates.g5plus.net/homeid/dashboard-add-new-property.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:23:02 GMT -->
...
<head>
  ...
  <!-- Facebook -->
  <meta property="og:url" content="dashboard-add-new-property.php">
...
<body>
              ...
              <ul class="list-group list-group-flush w-100">
                  ...
                  <!-- <div class="collapse" id="invoice_collapse">
                    <div class="card card-body border-0 bg-transparent py-0 pl-6">
                      <ul class="list-group list-group-flush list-group-no-border">
                        ...
                        <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                          <a class="text-heading lh-1 sidebar-link"
                            href="dashboard-edit-invoice.php">Edit
                            Invoice</a>
                        </li>
                        <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                          <a class="text-heading lh-1 sidebar-link"
                ...
                <li class="list-group-item pt-6 pb-4">
                  ...
                  <ul class="list-group list-group-no-border rounded-lg">
                    ...
                    <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                      <a href="dashboard-my-profiles.php" class="text-heading lh-1 sidebar-link">
                        <span class="sidebar-item-icon d-inline-block mr-3 text-muted fs-20">
                  ...
                  <li class="nav-item col">
                    <a class="nav-link active bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                      ...
                      role="tab" aria-controls="description" aria-selected="true"><span
                        class="number">1.</span> Description</a>
                  </li>
                  <li class="nav-item col">
                    <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                      ...
                      aria-controls="media" aria-selected="false"><span class="number">2.</span>
                      Media</a>
                  </li>
                  <li class="nav-item col">
                    <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                      ...
                      role="tab" aria-controls="location" aria-selected="false"><span
                        class="number">3.</span> Location</a>
                  </li>
                  <li class="nav-item col">
                    <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                  ...
                  <li class="nav-item col">
                    <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                      ...
                      role="tab" aria-controls="amenities" aria-selected="false"><span
                        class="number">5.</span> Amenities</a>
                  </li>
                </ul>
                <div class="tab-content shadow-none p-0">
                  <form method="POST" action="add_property_process.php">
                    <input type="hidden" name="property_id" value="123"> <!-- set property id appropriately -->
                                ...
                                <div class=" col-lg-6 card mb-6">
                                  <div class="card-body p-6">
                                    ...
                                    <div class="pt-6">
                                      ...
                                      <div class="form-row mx-n2">
                                        <div
                                          class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                          <div class="form-group">
                                            <label for="price"
                                              class="text-heading">Price in ₹
                          ...
                          <div id="media-collapse" class="collapse collapsible"
                            ...
                            <div class="card-body py-4 py-md-0 px-0">
                              <div class="row">
                                <div class="col-lg-6">
                                  <div class="dropzone upload-file text-center py-5" id="myDropzone">
                                    <div class="dz-default dz-message">
                                      ...
                                      <p class="text-heading fs-22 lh-15 mb-4">Drag &amp; drop images or</p>
                                      <button class="btn btn-indigo px-7 mb-2" type="button" id="browseBtn">Browse file</button>

                                      <!-- ✅ Actual file input that connects to PHP -->
                                      <input type="file" id="propertyImages" name="property_images[]" hidden="" multiple="">

                                      <p class="text-muted">Use JPEG or PNG format. Minimum size: 1024×768.</p>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                  <div class="card mb-6">
                                    <div class="card-body p-6">
                                      ...
                                      <div id="videosUploader" class="upload-box">
                                        <i class="fal fa-cloud-upload-alt upload-icon"></i>
                                        <p class="text-heading fs-22 lh-15 mb-4">Drag & drop videos here or</p>
                                        <button type="button" class="btn btn-indigo px-7 mb-2" id="videosBrowseBtn">
                                          Browse files
                                        </button>

                                        <!-- MULTIPLE VIDEOS -->
                                        <input type="file" id="videosInput" name="property_videos[]" accept="video/mp4" hidden multiple>

                                        <p class="text-muted mt-2">Videos must be MP4 (max 50 MB each)</p>
                                ...
                                <script>
                                  document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    const browseBtn = document.getElementById("videosBrowseBtn");
                                    const uploader = document.getElementById("videosUploader");
                                    ...
                                    uploader.addEventListener("drop", e => {
                                      if (e.dataTransfer.files.length > 0) {
                                        ...
                                        showVideos(e.dataTransfer.files);
                                      }
                                    });
                                    ...
                                    function showVideos(files) {
                                      ...
                                      Array.from(files).forEach(file => {
                                        if (file.type !== "video/mp4") {
                                          alert("Only MP4 videos allowed: " + file.name);
                                          return;
                                        }

                                        if (file.size > 50 * 1024 * 1024) {
                                          alert("Max size 50MB: " + file.name);
                                          return;
                                        }
                              ...
                              <div class="d-flex flex-wrap">
                                ...
                                <button class="btn btn-lg btn-primary next-button mb-3">Next
                                  step
                                  <span class="d-inline-block ml-2 fs-16"><i
                                      class="fal fa-long-arrow-right"></i></span>
                                </button>
                            ...
                            <div class="card-body py-4 py-md-0 px-0">
                              <div class="row">
                                ...
                                <div class="col-lg-6">
                                  <div class="form-group mb-3">
                                    <label for="mapIframeSrc">Google Map Embed Link (src)</label>
                                    <input
                                      type="text"
                                      id="mapIframeSrc"
                                      class="form-control"
                                      placeholder="Paste the map embed src URL here..."
                                      oninput="updateMapIframe()">
                                    <input
                                      type="text"
                                      id="mapIframeSrconly"
                                      class="form-control"
                                  ...
                                  <!-- Map Preview -->
                                  <div id="propertyMap1" style="height: 300px; border-radius: 8px; background: #f5f5f5; overflow:hidden;">
                                    <iframe
                                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62864.15576789484!2d77.42208521446307!3d10.01605392838903!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b071353e94a7877%3A0x962bf8fd53981722!2sTheni%2C%20Tamil%20Nadu%20625531!5e0!3m2!1sen!2sin!4v1762941929180!5m2!1sen!2sin"
                                      width="100%"
                                      height="100%"
                                      style="border:0;"
                                      allowfullscreen
                              ...
                              <div class="d-flex flex-wrap">
                                <a href="#" class="btn btn-lg bg-hover-white border rounded-lg mb-3 mr-auto prev-button">
                                  <span class="d-inline-block text-primary mr-2 fs-16"><i class="fal fa-long-arrow-left"></i></span>Prev
                                  step
                                </a>
                                <button class="btn btn-lg btn-primary next-button mb-3">Next
                                  step
                                ...
                                <div class="card-body p-6">
                                    ...
                                    <div class="col-lg-4">
                                      <div class="form-group">
                                        <label for="size-in-ft"
                                          class="text-heading">Size in ft <span
                                            class="text-muted">(only
                                            numbers)</span></label>
                                        <input type="text"
                                          class="form-control form-control-lg border-0"
                                          id="size-in-ft" name="size">
                                      </div>
                                    </div>
                                  ...
                                  <div class="row">
                                    <div class="col-lg-4">
                                      <div class="form-group">
                                        <label for="bedrooms"
                                          class="text-heading">Bedrooms</label>
                                        <input type="text"
                                          class="form-control form-control-lg border-0"
                                          id="bedrooms" name="bedroom">
                                      </div>
                                    </div>
                                    <div class="col-lg-4">
                                      <div class="form-group">
                                        <label for="available-from"
                                          ...
                                          <span
                                            class="text-muted">(date)</span></label>
                                        <input type="date"
                                          class="form-control form-control-lg border-0"
                                          id="available-from"
                                          name="available">
                                    ...
                                    <div class="col-lg-4">
                                      <div class="form-group">
                                        <label for="extra-details"
                                          class="text-heading">Extra
                                          details</label>
                                        <input type="text"
                                          class="form-control form-control-lg border-0"
                                          id="extra-details" name="extradetails">
                                      </div>
                                    </div>
                                  ...
                                  <div class="row">
                                    <div class="col-lg-4">
                                      <div class="form-group">
                                        <label for="garages"
                                          class="text-heading">Garages</label>
                                        <input type="text"
                                          class="form-control form-control-lg border-0"
                                    ...
                                    <div class="col-lg-4">
                                      <div class="form-group">
                                        ...
                                        <input type="text"
                                          class="form-control form-control-lg border-0"
                                          id="garage-size" name="garagesize">
                                      </div>
                                    </div>
                                    <div class="col-lg-4">
                                      <div class="form-group">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-4">
                                      <div class="form-group">
                                        <label for="roofing"
                                          class="text-heading">Roofing</label>
                                        <input type="text"
                                          class="form-control form-control-lg border-0"
                              ...
                              <div class="card mb-6">
                                <div class="card-body p-6">
                                  ...
                                  <p class="card-text mb-5">Lorem ipsum dolor sit amet,
                                    consectetur
                                    adipiscing elit</p>
                                  <div class=" d-flex justify-conten-evenly g-5">
                                    ...
                                    <ul class="list-group list-group-no-border">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[cctv]" id="cctv"
                                            value="24x7 Security / CCTV Surveillance">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[gated]" id="gated"
                                            value="Compound Wall & Gated Entrance">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[street_lights]" id="street_lights"
                                            value="Street Lights">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[wide_roads]" id="wide_roads"
                                            value="Wide Tar / Concrete Roads">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[underground_drain]" id="underground_drain"
                                            value="Underground Drainage System">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[water_supply]" id="water_supply"
                                            value="Water Supply (Individual/Borewell Connection)">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[electricity]" id="electricity"
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[rainwater]" id="rainwater"
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input feature-checkbox"
                                            name="features[play_area]" id="play_area"
                                        ...
                                        <div class="distance-field mt-2" style="display: none;">
                                          <input type="text" class="form-control form-control-sm"
                                            name="distance[play_area]" placeholder="Enter distance (e.g. 200 m)">
                                        </div>
                                      </li>
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[frontage]" id="frontage"
                                            value="Wide Frontage Road Access">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[high_footfall]" id="high_footfall"
                                            value="High Footfall / Visibility Area">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[parking]" id="parking"
                                            value="Parking Space Availability">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[ready_utilities]" id="ready_utilities"
                                            value="Electricity & Water Connection Ready">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[sewage]" id="sewage"
                                            value="Sewage and Drainage Facility">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input feature-checkbox"
                                            name="features[near_transport]" id="near_transport"
                                            value="Nearby Transport Facilities (Bus Stand / Railway / Airport)">
                                          <label class="custom-control-label" for="near_transport">
                                            Nearby Transport Facilities (Bus Stand / Railway / Airport)
                                          </label>
                                        </div>
                                        <div class="distance-field mt-2" style="display: none;">
                                          <input type="text" class="form-control form-control-sm"
                                            name="distance[near_transport]" placeholder="Enter distance (e.g. 200 m)">
                                        </div>
                                      </li>
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[approved_layout]" id="approved_layout"
                                            value="Approved Layout (DTCP / CMDA / RERA)">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[near_business]" id="near_business"
                                            value="Proximity to Business Centers">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input feature-checkbox"
                                            name="features[hospitals]" id="hospitals"
                                            value="Hospitals">
                                          <label class="custom-control-label" for="hospitals">Hospitals</label>
                                        </div>
                                        <div class="distance-field mt-2" style="display: none;">
                                          <input type="text" class="form-control form-control-sm"
                                            name="distance[hospitals]" placeholder="Enter distance (e.g. 1.5 km)">
                                        </div>
                                      </li>
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[borewell]" id="borewell"
                                            value="Borewell / Drip Irrigation Setup">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[fertile_soil]" id="fertile_soil"
                                            value="Fertile Soil">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[fencing]" id="fencing"
                                            value="Fencing / Boundaries">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[internal_pathways]" id="internal_pathways"
                                            value="Internal Pathways">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[farm_electricity]" id="farm_electricity"
                                            value="Electricity Connection">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[water_tank]" id="water_tank"
                                            value="Water Storage Tank">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[farmhouse]" id="farmhouse"
                                            value="Farmhouse / Workers’ Shed">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input feature-checkbox"
                                            name="features[near_water_source]" id="near_water_source"
                                            value="Nearby Water Source (River / Lake / Canal)">
                                          <label class="custom-control-label" for="near_water_source">Nearby Water Source (River / Lake / Canal)</label>
                                        </div>
                                        <div class="distance-field mt-2" style="display: none;">
                                          <input type="text" class="form-control form-control-sm"
                                            name="distance[near_water_source]" placeholder="Enter distance (e.g. 500 m)">
                                        </div>
                                      </li>
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[road_connectivity]" id="road_connectivity"
                                            value="Good Road Connectivity">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[plantation_ready]" id="plantation_ready"
                                            value="Plantation-Ready Land">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input feature-checkbox"
                                            name="features[wine_shop]" id="wine_shop"
                                            value="Wine Shop">
                                          <label class="custom-control-label" for="wine_shop">Wine Shop</label>
                                        </div>
                                        <div class="distance-field mt-2" style="display: none;">
                                          <input type="text" class="form-control form-control-sm"
                                            name="distance[wine_shop]" placeholder="Enter distance (e.g. 1 km)">
                                        </div>
                                      </li>
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[doorman]" id="doorman"
                                            value="Doorman">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[front_yard]" id="front_yard"
                                            value="Front yard">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input feature-checkbox"
                                            name="features[lake_view]" id="lake_view"
                                            value="Lake view">
                                          <label class="custom-control-label" for="lake_view">Lake view</label>
                                        </div>
                                        <div class="distance-field mt-2" style="display: none;">
                                          <input type="text" class="form-control form-control-sm"
                                            name="distance[lake_view]" placeholder="Enter distance (e.g. 800 m)">
                                        </div>
                                      </li>
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input feature-checkbox"
                                            name="features[ocean_view]" id="ocean_view"
                                            value="Ocean view">
                                          <label class="custom-control-label" for="ocean_view">Ocean view</label>
                                        </div>
                                        <div class="distance-field mt-2" style="display: none;">
                                          <input type="text" class="form-control form-control-sm"
                                            name="distance[ocean_view]" placeholder="Enter distance (e.g. 2 km)">
                                        </div>
                                      </li>
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[private_space]" id="private_space"
                                            value="Private space">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[sprinklers]" id="sprinklers"
                                            value="Sprinklers">
                                      ...
                                      <li class="list-group-item px-0 pt-0 pb-2">
                                        <div class="custom-control custom-checkbox">
                                          <input type="checkbox" class="custom-control-input"
                                            name="features[wine_cellar]" id="wine_cellar"
                                            value="Wine cellar">
                                    ...
                                    <script>
                                      $(document).ready(function() {
                                        ...
                                        $(".feature-checkbox").change(function() {
                                          const distanceField = $(this).closest("li").find(".distance-field");

                                          if ($(this).is(":checked")) {
                                            distanceField.slideDown(); // show with animation
                                          } else {
                                            distanceField.slideUp(); // hide if unchecked
                                            distanceField.find("input").val(''); // clear the field
                                          }
                                        });
                                      });
                                    </script>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      let selectedFiles = []; // store all selected files (merged from all selections)

      browseBtn.addEventListener("click", () => fileInput.click());

      // When files are selected from file browser
      fileInput.addEventListener("change", (e) => {
        const newFiles = Array.from(e.target.files);

        // ✅ Merge new files with existing ones (avoid duplicates by name & size)
      ...
      function renderPreviews() {
        // Remove old previews
        dropzone.querySelectorAll(".dz-preview-wrapper").forEach(el => el.remove());
        ...
        selectedFiles.forEach((file, index) => {
          if (file.type.startsWith("image/")) {
            ...
            reader.onload = (event) => {
              const wrapper = document.createElement("div");
              wrapper.className = "dz-preview-wrapper relative inline-block m-2  ";
              wrapper.style.position = "relative";
              wrapper.style.display = "inline-block";

              const img = document.createElement("img");
              img.src = event.target.result;
              img.className = "dz-preview rounded-lg shadow";
              ...
              dropzone.prepend(wrapper);
            };
            reader.readAsDataURL(file);
          }
        });

        // ✅ Update file input for PHP (combine all files)
  ...
  <script>
    function updateMapIframe() {
      let rawValue = document.getElementById("mapIframeSrc").value.trim();
      const mapContainer = document.getElementById("propertyMap1");
      const srconly = document.getElementById("mapIframeSrconly")

      // --- 1) If user pasted FULL iframe code, extract the src ---
      // Example:
      // <iframe src="URL" width="600"... ></iframe>
      const iframeMatch = rawValue.match(/<iframe[^>]*src=["']([^"']+)["']/i);

      if (iframeMatch) {
        rawValue = iframeMatch[1]; // extract only the URL
      }

      // --- 2) Validate: must be a Google Maps embed link ---
      const isValid = rawValue.startsWith("https://www.google.com/maps/embed?");

      // --- 3) If valid, render map ---
      if (rawValue && isValid) {
    ...
    `;
        srconly.value = rawValue;
      } else if (rawValue && !isValid) {
        mapContainer.innerHTML = `
      <div style="display:flex;align-items:center;justify-content:center;height:100%;color:#666;text-align:center;padding:10px;">
        <p>Please enter a valid Google Maps <strong>embed src</strong> URL.</p>
      </div>
    `;
      } else {
