...
include('connect.php');
// ✅ If admin clicked Accept or Reject
if (isset($_GET['action']) && isset($_GET['id'])) {
    $id = intval($_GET['id']);
    $action = $_GET['action'];

    if ($action == 'accept') {
        $conn->query("UPDATE users SET status='accepted' WHERE id=$id");
...
<!-- Mirrored from templates.g5plus.net/homeid/dashboard.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:23:00 GMT -->
...
<body>
    <div class="wrapper dashboard-wrapper">
                    ...
                    <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
                        <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                            <div class="mr-0 mr-md-auto">
                                <h2 class="mb-0 text-heading fs-22 lh-15">Welcome back,<?php echo $_SESSION['username']; ?>!</h2>
                                <p>    Review seller requests and take appropriate approval actions.</p>
                            </div>
                            <div>
                                <a href="dashboard-add-new-property.php" class="btn btn-primary btn-lg">
                        ...
                        <div class="table-responsive">
                            <h2 class="mb-2 text-heading fs-22 lh-15">User Approvals</h2>
                            <table class="table table-hover bg-white border rounded-lg">
                                <thead class="thead-sm thead-black">
                                    <tr>
                                        <th scope="col" class="border-top-0 px-6 pt-5 pb-4">ID</th>
                                        <th scope="col" class="border-top-0 pt-5 pb-4">Mobile</th>
                                        <th scope="col" class="border-top-0 pt-5 pb-4">Username</th>
        ...
        <span class="badge text-capitalize font-weight-normal fs-12 ' . $badgeClass . '">'
                                        ...
                                        if ($row['status'] == 'pending') {
                                            echo "<td>
              <a class='accept btn btn-success' href='dashboard.php?action=accept&id={$row['id']}'>Accept</a>
              <a class='reject btn btn-danger  ' href='dashboard.php?action=reject&id={$row['id']}'>Reject</a>
              </td>";
                                        } else {
                                            echo "<td>—</td>";
                                        }
...
<!-- Mirrored from templates.g5plus.net/homeid/dashboard.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Oct 2025 12:23:02 GMT -->
